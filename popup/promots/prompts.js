const PROMPT_TEMPLATES = {
  ...
  代码方法的栈帧和变量含义: {
    ...
    label: "代码方法的栈帧和变量含义",
    template:
      "%s 尝试输出这段代码中所有变量名和方法名的含义 以及功能 基本的代码语境, 清晰的指出作用域 ,方法方面: 介绍调用栈方法的调用栈 以及里面的控制语句的逻辑, 并且生成一个相同功能的伪代码 方便理解",
  },
  ...
  帮助我修复bug: {
   ...
   你无法修复这个bug: {
    ...
    label: "你无法修复这个bug",
    template:
      "%s ,要求: 我放弃让你提供答案,你不需要提供任何细节的修改代码,只需要提供排除思路,控制相关的日志,以及提供验证的流程,并且每一步都生成特殊的知识点 进行框架的搭建,你不需要进行任何答案输出 重点是排除流程",
  },
  技术组合和比较: {
    group: "analyze_plan",
    label: "技术组合和比较",
