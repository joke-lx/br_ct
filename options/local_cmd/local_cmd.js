    ...
    return `
      <div class="skill-card">
        ...
        <div class="skill-card-actions">
          ${!projectSkill ? `<button class="btn btn-pull" data-action="skill-push-central-to-project" data-name="${escapeHtml(s.name)}">→ 推送到项目</button>` : ''}
